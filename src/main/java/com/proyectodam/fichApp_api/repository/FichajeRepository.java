...
public interface FichajeRepository extends JpaRepository<Fichaje, Integer> {
    ...
    List<Fichaje> findByEmpleadoIdEmpleadoAndTimestampServidorBetween(int idEmpleado, LocalDateTime inicio, LocalDateTime fin);

    Optional<Fichaje> findTopByEmpleadoIdEmpleadoAndTimestampServidorBetweenOrderByTimestampServidorDesc(int idEmpleado, LocalDateTime iniciaDia, LocalDateTime findDia);
